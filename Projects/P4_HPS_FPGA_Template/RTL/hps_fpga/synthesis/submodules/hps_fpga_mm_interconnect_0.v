...
module hps_fpga_mm_interconnect_0 (
	...
	wire  [112:0] pio_leds_s1_agent_rf_source_data;                     // pio_leds_s1_agent:rf_source_data -> pio_leds_s1_agent_rsp_fifo:in_data
	...
	wire  [112:0] pio_leds_s1_agent_rsp_fifo_out_data;                  // pio_leds_s1_agent_rsp_fifo:out_data -> pio_leds_s1_agent:rf_sink_data
	...
	wire  [111:0] pio_leds_s1_agent_rp_data;                            // pio_leds_s1_agent:rp_data -> router_002:sink_data
	...
	wire          cmd_mux_src_valid;                                    // cmd_mux:src_valid -> pio_leds_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_src_data;                                     // cmd_mux:src_data -> pio_leds_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                    // pio_leds_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                  // cmd_mux:src_channel -> pio_leds_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                            // cmd_mux:src_startofpacket -> pio_leds_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                              // cmd_mux:src_endofpacket -> pio_leds_s1_burst_adapter:sink0_endofpacket
	wire          pio_leds_s1_burst_adapter_source0_valid;              // pio_leds_s1_burst_adapter:source0_valid -> pio_leds_s1_agent:cp_valid
	wire  [111:0] pio_leds_s1_burst_adapter_source0_data;               // pio_leds_s1_burst_adapter:source0_data -> pio_leds_s1_agent:cp_data
	wire          pio_leds_s1_burst_adapter_source0_ready;              // pio_leds_s1_agent:cp_ready -> pio_leds_s1_burst_adapter:source0_ready
	wire    [1:0] pio_leds_s1_burst_adapter_source0_channel;            // pio_leds_s1_burst_adapter:source0_channel -> pio_leds_s1_agent:cp_channel
	...
	wire          pio_leds_s1_agent_rdata_fifo_out_valid;               // pio_leds_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] pio_leds_s1_agent_rdata_fifo_out_data;                // pio_leds_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          pio_leds_s1_agent_rdata_fifo_out_ready;               // avalon_st_adapter:in_0_ready -> pio_leds_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                        // avalon_st_adapter:out_0_valid -> pio_leds_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                         // avalon_st_adapter:out_0_data -> pio_leds_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                        // pio_leds_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                        // avalon_st_adapter:out_0_error -> pio_leds_s1_agent:rdata_fifo_sink_error
